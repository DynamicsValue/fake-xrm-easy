...
namespace DataverseEntitiesPartial
{
	...
	public partial class Task : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public DataverseEntitiesPartial.Account Account_Tasks
		{
			get
			{
				return this.GetRelatedEntity<DataverseEntitiesPartial.Account>("Account_Tasks", null);
			}
			set
			{
				this.OnPropertyChanging("Account_Tasks");
				this.SetRelatedEntity<DataverseEntitiesPartial.Account>("Account_Tasks", null, value);
		...
		public DataverseEntitiesPartial.Contact Contact_Tasks
		{
			get
			{
				return this.GetRelatedEntity<DataverseEntitiesPartial.Contact>("Contact_Tasks", null);
			}
			set
			{
				this.OnPropertyChanging("Contact_Tasks");
				this.SetRelatedEntity<DataverseEntitiesPartial.Contact>("Contact_Tasks", null, value);
